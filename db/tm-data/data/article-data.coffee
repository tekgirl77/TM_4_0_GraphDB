...
addData = (graphService, callback)->
  data = []

  addMappings data, "keyword_00000762fc3e",  [ { title     : "TM DATA - SQL Injection"          },
                                               { is        : "Search"                           },
  ...
  # Query
  addMappings data, "query-10002762fc3e"  ,  { is: "Query",   title: "Perform SQL Validation on the Server", xref: ['xref-31002762fc3e'
                                                                                                                'xref-32002762fc3e'
                                                                                                                'xref-33002762fc3e'
                                                                                                                'xref-34002762fc3e'
                                                                                                                'xref-35002762fc3e'
                                                                                                                'xref-36002762fc3e'
                                                                                                                'xref-37002762fc3e']}
  addMappings data, "query-20002762fc3e"  ,  { is: "Query",   title: "Validate SQL Input"              , xref: ['xref-38002762fc3e'
                                                                                                                'xref-39002762fc3e'
                                                                                                                'xref-41002762fc3e']}

  addMappings data, "query-30002762fc3e"  ,  { is: "Query",   title: "Use White-list Validation for SQL"       , xref: ['xref-42002762fc3e'
                                                                                                                'xref-43002762fc3e'
                                                                                                                'xref-44002762fc3e'
                                                                                                                'xref-45002762fc3e']}
  ...
  # Articles
  #addMappings data, "article-e7ed2762fc3e",  { is: 'Article', title : 'All Input Is Validated'                    ,  guid: 'a330bfdd-9576-40ea-997e-e7ed2762fc3e' , summary: 'On Html 5, Verify that whitelist (positive) input validation is used to filter all input.'}
  #addMappings data, "article-d5bc580df781",  { is: 'Article', title : 'All Input Is Validated'                    ,  guid: 'cde61562-aff2-40a0-beb9-d5bc580df781' , summary: 'On Android, Properly implemented input validation is effective at preventing many types of injection vulnerabilities, such as Cross-Site Scripting and SQL injection.'}
  #addMappings data, "article-9771b8ed3eda",  { is: 'Article', title : 'All Input Is Validated'                    ,  guid: 'ed7404ea-00fa-4f4c-a692-9771b8ed3eda' , summary: 'On iOS, Verify that all input is validated. Properly implemented input validation mitigates many types of injection vulnerabilities, such as Cross-Site Scripting and SQL injection.'}
  #addMappings data, "article-1106d793193b",  { is: 'Article', title : 'All Input Is Validated'                    ,  guid: '0f3bb6f1-9058-463f-a835-1106d793193b' , summary: 'On C++, Ensure that all input is validated. Validation routines should check for length, range, format, and type. Validation should check first for known valid and safe data and then for malicious, dangerous data.'}
