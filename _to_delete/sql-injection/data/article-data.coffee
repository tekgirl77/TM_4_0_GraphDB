...
addData = (options, callback)->
  ...
  options.data.addMappings "keyword_00000762fc3e",  [ { title     : "SQL Injection"                  },
    { is        : "Search"                           },
  ...
  # Query
  options.data.addMappings "query-10002762fc3e"  ,  { is: "Query",   title: "Perform SQL Validation on the Server", xref: ['xref-31002762fc3e'
                                                                                                                'xref-32002762fc3e'
                                                                                                                'xref-33002762fc3e'
                                                                                                                'xref-34002762fc3e'
                                                                                                                'xref-35002762fc3e'
                                                                                                                'xref-36002762fc3e'
                                                                                                                'xref-37002762fc3e']}
  options.data.addMappings "query-20002762fc3e"  ,  { is: "Query",   title: "Validate SQL Input"              , xref: ['xref-38002762fc3e'
                                                                                                                'xref-39002762fc3e'
                                                                                                                'xref-41002762fc3e']}

  options.data.addMappings "query-30002762fc3e"  ,  { is: "Query",   title: "Use White-list Validation for SQL"       , xref: ['xref-42002762fc3e'
                                                                                                                           'xref-43002762fc3e'
                                                                                                                           'xref-44002762fc3e'
                                                                                                                           'xref-45002762fc3e']}

  options.data.addMappings "query-40002762fc3e"  ,  { is: "Query",   title: "Don't use SQL based databases"           , xref: ['xref-42002762fc3e'
                                                                                                                           'xref-43002762fc3e'
                                                                                                                           'xref-44002762fc3e'
                                                                                                                           'xref-45002762fc3e']}
